-- Link Desafio:  https://www.beecrowd.com.br/judge/pt/problems/view/2997
-- Link Resposta: https://www.beecrowd.com.br/judge/pt/runs/code/37448293
...
SELECT departamento.nome,
       ...
       COALESCE(salarios_brutos.valor, 0) AS Salario_Bruto,
       COALESCE(descontos.valor, 0) AS Total_Desconto,
       (COALESCE(salarios_brutos.valor, 0) - COALESCE(descontos.valor, 0)) AS salario_Liquido
FROM empregado
...
-- Dados Iniciais
CREATE TABLE departamento(cod_dep int, nome varchar(50), endereco varchar(50));
